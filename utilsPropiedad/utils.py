    ...
    def sacaDir(self):
        ...
        if sys.platform=='linux2':
            ...
            if not(os.path.exists(ruta)):
                e=Exception("No se localiza el archivo " + ruta + ". Pulse el boton de la ayuda (?) para obtener ayuda sobre la instalacion.")
                raise e
        #existe el archivo
        ...
        sin acentos ni enyes, y con barras de dividir. Debe introducir dos guiones despues de la ruta. Por ejemplo c:/delProp--. Guarde el archivo con codifiacion ANSI. Pulse el boton de la ayuda (?) para obtener ayuda sobre la instalacion.")
                    raise e
...
Por ejemplo c:/delProp--, para Windows, o bien /home/user/trabajos/topoDelProp-- en Linux. En Windows guarde el archivo con codifiacion ANSI. Pulse el boton de la ayuda (?) para obtener ayuda sobre la instalacion."
            raise e
        finally:
            f.close()
        if not "--" in ruta2:
...
Guarde el archivo con codifiacion ANSI. En Linux debe ser algo asÃ­: /home/user/trabajos/topoDelProp--. Pulse el boton de la ayuda (?) para obtener ayuda sobre la instalacion.")
            raise ee
        else:
    ...
    def sacaLectorPDF(self):
        if sys.platform=='linux2':
            ...
            ruta='/home/' + usuario + '/dirTrabajos.txt'
            if not(os.path.exists(ruta)):
                e=Exception("No se localiza el archivo " + ruta + ". Debe introducir dos guiones despues de la ruta al directorio de los trabajos. Por ejemplo /home/user/trabajos/topoDelProp--. Pulse el boton de la ayuda (?) para obtener ayuda sobre la instalacion.")
                raise e
        else:
            dirBase=sys.path[2]#directorio base de la aplicaciÃ³n c:/users/.../.qgis/python/plugins
            ruta=dirBase + "/TopoDelProp/dirTrabajos.txt"
    ...
    del plugin TopoDelProp, o en c:/ y contener una linea con la ruta a los trabajos, \
    sin acentos ni enyes, y con barras de dividir. Por ejemplo c:/delProp--. Guarde el archivo con codificacion ANSI. Pulse el boton de la ayuda (?) para obtener ayuda sobre la instalacion."
                    raise e
...
Note los dos guiones al final de la linea. En Linux podria ser evince--. Pulse el boton de la ayuda (?) para obtener ayuda sobre la instalacion."
            raise e
        finally:
            f.close()
        if not "--" in linea2:
...
Escriba debajo de la ruta a los trabajos una linea como la siguiente: \
C:/Program Files (x86)/Adobe/Reader 9.0/Reader/AcroRd32.exe--. \
Guarde el archivo con codifiacion ANSI. En Linux podria ser evince--. Pulse el boton de la ayuda (?) para obtener ayuda sobre la instalacion.")
    ...
    Escriba debajo de la ruta a los trabajos una linea como la siguiente: \
    C:/Program Files (x86)/Adobe/Reader 9.0/Reader/AcroRd32.exe--. \
    Guarde el archivo con codifiacion ANSI. Pulse el boton de la ayuda (?) para obtener ayuda sobre la instalacion."
                raise ee
...
class Varios(object):
    ...
    def cargaCapas(self,tipoTrabajo, oUtiles,borrarSiExiste):
        ...
        tablas=["fincas","lindes","img_linde","elem_interiores","servidumbres"]
